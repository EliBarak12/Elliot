...
| [081](081-demo-connector-welcome.md) | Preloaded demo connector + Studio `/welcome` | A new user's first 60 seconds end at a working tool call and a live trace, not an empty dashboard |
